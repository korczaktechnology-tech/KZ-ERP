...
export type FinancialEntry = BaseDocument & { description: string; type: 'receivable' | 'payable'; status: 'open' | 'paid' | 'cancelled'; amount: number; dueDate: Date; paidAt?: Date; reference?: string };
