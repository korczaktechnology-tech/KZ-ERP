...
export async function ensureMasterDataCollections(db: Db): Promise<void> {
  const definitions: Record<string, Array<{ key: Record<string, 1 | -1>; options?: Record<string, unknown> }>> = {
    ...
    addresses: [
      { key: { companyId: 1, partyId: 1, type: 1, code: 1 }, options: { unique: true, name: 'addresses_party_type_code_unique' } },
      { key: { companyId: 1, partyId: 1, active: 1 } },
      { key: { companyId: 1, postalCode: 1 } }
    ],
    units: [
