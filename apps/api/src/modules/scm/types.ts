...
export type ScmOutboxEvent = { _id: Id; companyId: Id; type: string; aggregateType: string; aggregateId: Id; payload: Record<string, unknown>; status: 'pending' | 'processing' | 'published' | 'dead_letter'; attempts: number; availableAt: Date; lastError?: string; createdAt: Date; updatedAt: Date };
