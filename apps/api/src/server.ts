...
app.get('/api/v1/system', (_req, res) => res.json({ data: { name: 'KORCZAK ERP', version: process.env.APP_VERSION ?? '0.1.0', integrationNamespaces: ['CORE','WMS','TMS','CRM','FINANCE','FISCAL','PEOPLE','SALES','COMMERCE','QUALITY','MAINTENANCE','DOCUMENTS','ASSETS','FIELD','SERVICE','PROJECTS'] } }));
