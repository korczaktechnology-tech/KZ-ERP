...
app.get('/api/v1/system',(_req,res)=>res.json({data:{name:'KORCZAK ERP',version:APP_VERSION,integrationNamespaces:['CORE','WMS','TMS','CRM','SCM','FINANCE','FISCAL','PEOPLE','SALES','COMMERCE','QUALITY','MAINTENANCE','DOCUMENTS','ASSETS','FIELD','SERVICE','PROJECTS']},requestId:res.locals.requestId}));
